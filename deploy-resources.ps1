...
$output = az storage account create --name "storgaeskidi" --resource-group "rg_tobiasholmegaard"
Throw-WhenError -output $output

$output = az functionapp create --name "imageFile" --resource-group "rg_tobiasholmegaard" --storage-account "storgaeskidi" --consumption-plan-location "northeurope"
Throw-WhenError -output $output

$output = az appservice plan create --name "funcAppService" --resource-group "rg_tobiasholmegaard"
Throw-WhenError -output $output
